      ...
      <v-col cols="12" sm="10">
        <div class="mb-10">
          <v-card flat class=" mt-12">
            <div class="titlefont"><strong>세일 제보</strong> 게시판</div>
          </v-card>
        ...
        <v-row no-gutters>
          ...
          <v-col cols="12" sm="10">
            <v-tabs
              ...
              color="sub"
            >
              <v-tab to="/board" class="ml-1 text-decoration-none grey--text font-weight-medium">
                전체 게시판
              </v-tab>
              <v-tab
                to="/board/free"
                class="ml-1 text-decoration-none  grey--text font-weight-medium"
              >
                자유 게시판
              </v-tab>
              <v-tab
