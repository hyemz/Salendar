...
export default {
  ...
  created() {
    ...
    axios
      .get(`http://i4a301.p.ssafy.io/api/boardList/${this.$route.params.boardNo}`)
      .then((res) => {
  ...
  methods: {
    ...
    update () {
      ...
      axios
        ...
        .post(`http://i4a301.p.ssafy.io/api/boardList/token/${this.$route.params.boardNo}`, BoardModifyForm)
        .then((res) => {
          console.log(res);
